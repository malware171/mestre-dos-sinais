...
function setError(index) {
   $(campos[index]).addClass('border, focus:border-red-500')
   $(spans[index]).removeClass('hidden')
}

function removeError(index) {
   $(campos[index]).removeClass('focus:border-red-500')
   $(spans[index]).addClass('hidden')
}
